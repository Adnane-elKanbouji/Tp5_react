...
export default function PageEror() {
  return (
    <div class="wrapper" style={{width:"80%",marginLeft:"10%"}} ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
  <title>404</title>
  <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
    ...
    <rect class="cls-1" x="680.91" y="871.98" width="200" height="8.39" rx="4.19" ry="4.19"/>
